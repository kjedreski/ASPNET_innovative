   ...
   // public string username { get; set; }
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Generate_hashtable()
        {
            ...
            Site_Keys.Add("adamspeanutbutter", 9);
            ...
            /*
                ...
                mydb.connect();
                    // first sqlDataReader is for finding the personal info with email. (CMS_USER)
                      SqlDataReader rdr = mydb.execsp("CMS_RecipeBox_NewSearch", new Object[,] {
                      });
                      CheckBoxList7.DataSource = rdr;

                      CheckBoxList7.DataTextField = "URI";
                      CheckBoxList7.DataValueField = "Common_WebSiteID";
